...
cdf2a <- as.data.frame(sapply(X=cdf2a, FUN=cleaner6), stringsAsFactors = FALSE)
...
# Yujun Zhang is the most central person in the class; they have both the highest degree and betweenness centrality
