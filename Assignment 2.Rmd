...
#Arrow size
plot(g,layout=layout.fruchterman.reingold, vertex.color=VERTEX$gender, edge.width=EDGE$count, edge.arrow.size=2)

#Remove the labels
plot(g,layout=layout.fruchterman.reingold, vertex.color=VERTEX$gender, edge.width=EDGE$count, vertex.label=VERTEX$topic)
...
```{r}
EDM_Class <- read.csv("hudk4050-classes.csv")
View(EDM_Class)
