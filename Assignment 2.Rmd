...
names(C2) <- c("id", "count")
C3 <- rbind(C1, C2)
VERTEX2 <- full_join(VERTEX, C3)
plot(g, layout = layout.fruchterman.reingold, vertex.color = VERTEX$gender, edge.width = EDGE$count, vertex.size = VERTEX2$count)
