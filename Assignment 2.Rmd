...
```{r}
#Read in data
raw_data <- read.csv("hudk4050-classes_new.csv")
#Select relevant variables
library(tidyr)
DF_new<-unite(raw_data, Name, "First.Name","Last.Name", sep = " ")
DF_new
rownames(DF_new) <- DF_new$Name
class_DF <- DF_new %>% select(id = 'Name',
                                class1 = 'Class.1',
                                class2 = 'Class.2',
                                class3 = 'Class.3',
                                class4 = 'Class.4',
