...
```{r}
D1 <- read.csv("E:/TC/4050/GITHUB/assignment2/discipline-data.csv")
View(D1)
```
...
plot(g,layout=layout.fruchterman.reingold, vertex.color=VERTEX$gender, edge.width=EDGE$count, edge.arrow.size=0.3, vertex.label=NA, vertex.size=10)
```
...
P1 <- read.csv("E:/TC/4050/GITHUB/assignment2/hudk4050-classes.csv", header = TRUE)
