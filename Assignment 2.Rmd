...
#And many others!
### Repo of graph 
e.wt <- get.edge.attribute(g, "weight")
png(file="figures/Teachers-Students Repo.png", width=800, height=800, res=150)
plot(g, layout=layout.fruchterman.reingold, vertex.size=5,edge.width=e.wt,vertex.label=V(g)$name,vertex.color=VERTEX$gender)
dev.off()
```
