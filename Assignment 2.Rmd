...
g
plot(g,layout=layout.fruchterman.reingold,vertex.size = VERTEX1$count*2)
```
...
```{r}
hudk4050.classes <- read.csv("hudk4050-classes.csv", header = TRUE)
D3 <- data.frame(hudk4050.classes)
D3
```
