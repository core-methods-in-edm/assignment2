...
#Since everyone is taking HUDK4050, we can remove it to make the graph more informative. 
df4$"4050" <- NULL
...
```{r}
View(betweenness(g3, directed=T, weights=NA))
View(degree(g3, mode="in"))

#47, or yz3679, has the highest betweeness centrality.
```
