...
Score2 = round(rtnorm(100, lb = 0, ub = 100, sd = 15, mu = 75))

set.seed(102)
ClassificationOptions <- c("sport", "music", "nature", "literature")
Classification <- sample(ClassificationOptions, 100, replace=TRUE)

SDS1 <- data.frame(StudID, Score2, Classification)
...
hist(Score2, main = "Distribution of Scores", breaks = 100)

#https://stackoverflow.com/questions/38810453/how-to-plot-a-histogram-with-different-colors-in-r

hist(Score2, main = "Distribution of Scores", breaks = 100, col = 3)

#colors http://www.stat.columbia.edu/~tzheng/files/Rcolor.pdf

hist(Score2, main = "Distribution of Scores", breaks = c(seq(0,100,10)), col = c("steelblue", "steelblue1", "steelblue2", "steelblue3", "steelblue4"))
...
#Score2Cuts <- cut(Score2, breaks = c(seq(0,100,10)), labels = "A","B","C","D","E","F","G","H","I","K")
SDS1$Score2Cuts <- cut(Score2, breaks = c(seq(0,100,10)), labels = c("A","B","C","D","E","F","G","H","I","K"))
...
#hist(Score2, main = "Distribution of Scores", brewer.pal(10,"Set1"))


#hist(Score2, main = "Distribution of Scores", breaks = c(seq(0,100,10)), brewer.pal(10,"Set1"))
