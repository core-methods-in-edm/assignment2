...
```{r}
plot(S3$login, S3$score, col = S3$colors, main = "Student Login vs. Scores")
...
```{r}
DF3 <- DF1 %>% group_by(hash, lesson_name) %>% summarise(attempts = sum(attempt))
