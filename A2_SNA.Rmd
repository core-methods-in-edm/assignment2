...
plot(g,layout=layout.fruchterman.reingold, vertex.color= ifelse(VERTEX$gender=='female','blue','red'))


#We can change the thickness of the edge according to the number of times a particular teacher has sent a particular student to the principal.

plot(g,layout=layout.fruchterman.reingold, vertex.color=VERTEX$gender== (ifelse(VERTEX$gender=='female','blue','red')), edge.width=EDGE$count)
```
...
```{r}
plot(g, layout=layout.fruchterman.reingold, edge.width=EDGE$count, vertex.size=20)
```
